<template>
    <div>
        ...
        <div class="selection">
            ...
            <button class="btn btn-outline-secondary btn-lg btn-block mb-3" @click="goResults()">> {{ $t('skip') }} ></button>
            ...
            <button class="btn btn-success btn-lg btn-block mt-3" @click="goResults()">> {{ $t('result') }} ></button>
        </div>
