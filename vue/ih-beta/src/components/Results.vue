    ...
    <div>
        ...
        <div class="results">
            ...
            <div class="row px-2">
                ...
                <div class="col-md-6">
                    <a :href="createEmailLink()">
                        <button class="btn btn-warning btn-block btn-lg" @click="clicked('email_top', {})">{{ $t('send_by_email')}} <i class="fa fa-envelope"></i></button>
                    </a>
                </div>
            </div>
            ...
            <div class="row px-2">
                <div class="col-md-6">
                    <a :href="createFBLink()" target="_blank">
                        <button @click="clicked('fb_lower', {})" class="btn btn-primary btn-block btn-lg">{{ $t('share_on_fb') }}<i class="fa fa-facebook-official"></i></button>
                    </a>
                </div>
                <div class="col-md-6">
                    <a :href="createEmailLink()">
                        <button class="btn btn-warning btn-block btn-lg" @click="clicked('email_lower', {})">{{ $t('send_by_email')}} <i class="fa fa-envelope"></i></button>
                    </a>
                </div>
            </div>
