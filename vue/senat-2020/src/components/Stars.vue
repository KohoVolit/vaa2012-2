<template>
    <div class="stars" :class="muted_class">
        <font-awesome-icon v-for="(n, index) in full" :key="index" icon="star" /><font-awesome-icon v-for="(n, index) in half" :key="index" icon="star-half-alt" /><font-awesome-icon v-for="(n, index) in empty" :key="index" :icon="['far', 'star']" />
    </div>
</template>
