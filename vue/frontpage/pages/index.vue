<template>
  <div class="container page">
    <h1 class="pt-4 name">
      Volební kalkulačka<sup><a href="https://isdv.upv.cz/webapp/resdb.print_detail.det?pspis=OZ/542865&amp;plang=CS" target="_blank">®</a></sup> 2021
    </h1>
    ...
    <p class="teaser">
      ...
      <div class="d-grid p-2">
        <NuxtLink to="/cs/inventura-hlasovani-2017-2021/" class="btn btn-success btn-lg disabled">SPUSTIT INVENTURU HLASOVÁNÍ 2017-2021 <br/> ✋ </NuxtLink>
      </div>
    ...
    <p class="teaser">
      ...
      <div class="d-grid p-2">
        <NuxtLink to="/volby-2021" class="btn btn-success btn-lg disabled" disabled>😷 ZDRAVOTNICKÁ VOLEBNÍ KALKULAČKA <br/> (Od ?.9.2021)</NuxtLink>
      </div>
    ...
    <p class="teaser">
      ...
      <div class="d-grid p-2">
        <NuxtLink to="/volby-2021" class="btn btn-success btn-lg disabled" disabled>♥ ULTIMÁTNÍ VOLEBNÍ KALKULAČKA <br/> (Od 9.9.2021 21:21)</NuxtLink>
      </div>
