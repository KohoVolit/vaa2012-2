...
import candidates from "../content/answers_young.json";
import questions from "../content/questions_young.json";
...
export default {
  ...
  head: function() {
    return {
      title: 'Mladí volí, volební kalkulačka 2021 - porovnání',
      meta: [
        {
          hid: 'comparison',
          name: 'Porovnání',
          description: 'Mladí volí, volební kalkulačka 2021 - porovnání'
        }
      ]
    }
  },
