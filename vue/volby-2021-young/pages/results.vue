...
export default {
  async asyncData ({ $content }) {
    const candidates = await $content('answers_young').fetch()
    return { candidates }
  },

  head: function() {
    return {
      title: 'Mladí volí, Volební kalkulačka 2021 - výsledky',
      meta: [
        {
          hid: 'results',
          name: 'Mladí volí, Výsledky volební kalkulačky',
          description: 'Mladí volí, Volební kalkulačka 2021 - výsledky'
        }
      ]
    }
  },
