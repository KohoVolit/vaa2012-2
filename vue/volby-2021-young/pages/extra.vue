...
export default {
  async asyncData ({ $content }) {
    const questions = await $content('questions_young').fetch()
    return { questions }
  },

  head: function() {
    return {
      title: 'Mladí volí, volební kalkulačka 2021 - důležité otázky',
      meta: [
        {
          hid: 'extra',
          name: 'Důležité otázky',
          description: 'Mladí volí, volební kalkulačka 2021 - důležité otázky'
        }
      ]
    }
  },
