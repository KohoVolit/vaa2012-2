            ...
            <div class="col-md-6 col-md-offset-3 text-center" style="padding-top:2em;">
                    ...
                    <p class="lead">
                            ...
                            <div class="row">
                                ...
                                <a href="cs/jihlava-2018/?<?php //echo $_SERVER['QUERY_STRING']; ?>&hr=<?php if( isset($_SERVER['HTTP_REFERER'])) { $hr=$_SERVER['HTTP_REFERER']; if ($hr!="") {echo base64_encode($hr);} } ?>" class="btn btn-lg btn-success" style="white-space: normal;" disabled>
