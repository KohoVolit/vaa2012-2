...
/<?php echo $_smarty_tpl->getVariable('number_questions')->value;?>
	...
	<div id="progress_box" class="ui-body ui-body-c computer">
        <div id="progresstext" data-role="heading">Otázka <?php echo $_smarty_tpl->tpl_vars['key']->value;?>
 z <?php echo $_smarty_tpl->getVariable('number_questions')->value;?>
</div>
        <div id="progressbar">
          <div style="width:<?php echo ceil(((100*($_smarty_tpl->tpl_vars['key']->value))/$_smarty_tpl->getVariable('number_questions')->value));?>
%" class="ui-body-e">&nbsp;</div>
        </div>
    </div><!-- /progressbar -->
...
" data-transition="slidefade" data-role="button" data-icon="arrow-r" data-theme="c" data-mini="true" data-iconpos="right"><?php if (($_smarty_tpl->tpl_vars['key']->value)==$_smarty_tpl->getVariable('number_questions')->value){?>Dále<?php }else{ ?>Další otázka<?php }?></a>
	    <!-- /navigation -->
