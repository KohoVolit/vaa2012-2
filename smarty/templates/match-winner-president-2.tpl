<div class="box-center-match match-winner-box">
	<p>Dle zadaných odpovědí je Vám blíže se shodou <strong>{$results[0].result_percent}&nbsp;%</strong> :</p>
	<div style="color:#{$winner_color}" class="match-winner">{$results[0].name}</div>
	</style>
...
<p>Graf a tabulka ukazují, jak se s Vámi shodují oba kandidáti:</p>
</div>
