    	...
    	<h3>Vložit kalkulačku k sobě na web</h3>
            <div data-role="fieldcontain">
				<p>Vložte kód HTML (standardní Volební kalkulačka):</p>
					<textarea data-role="none" cols="40" rows="3" name="textarea" id="textarea"><iframe src="http://volebnikalkulacka.cz/volba-rektora-univerzita-karlova-2013/?key=result" width="650" height="550" frameborder="0" ></iframe></textarea><br/>
