...
<!-- Start of 0 page -->
<div data-role="page" id="p0" data-title="{$question->name} | {$text.page_header_desktop}">
    <!-- header -->
	{include "psp2013iinfo-page-header.tpl"}
	<!-- /header -->
	
	<!-- content -->
    <div data-role="content" class="content">
    
          {include "psp2013-page-0.tpl"}
          
          
    </div> <!-- /content -->	
	
	<!-- footer -->
	{include "psp2013iinfo-page-footer.tpl"}
	<!-- /footer -->
