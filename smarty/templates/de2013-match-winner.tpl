  ...
  <div class="ui-grid-b computer">
	...
	<div class="ui-block-a">
	  <div class="match-winner-block">
		<div style="color:#{$winner_color[0]}" class="match-winner">{$results[0].party}<div style="font-size:.5em">{$results[0].party_long}</div></div>
	...
	<div class="ui-block-b">
	  <div class="match-winner-block">
		<div style="color:#{$winner_color[1]}" class="match-winner">{$results[1].party}<div style="font-size:.5em">{$results[1].party_long}</div></div>
	...
	<div class="ui-block-c">
	  <div class="match-winner-block">
		<div style="color:#{$winner_color[2]}" class="match-winner">{$results[2].party}<div style="font-size:.5em">{$results[2].party_long}</div></div>
	...
	<div class="mobile">
	  <div class="match-winner-block">
	      <div class="ui-grid-a">
	        <div class="ui-block-a">
			  <div style="color:#{$winner_color[0]}" class="match-winner">{$results[0].party}</div>
		    </div>
		    <div class="ui-block-b">
			  <div class="match-winner-percentage"><span class="match-winner-percentage-number">{$results[0].result_percent}</span> %</div>
		    </div>
...
<!--<a data-role="button" data-theme="c" title="Sdílej výsledky na Facebooku" 
	...
	<a data-role="button" data-theme="c" href={include "de2013-match-facebook-link.tpl"}	  
