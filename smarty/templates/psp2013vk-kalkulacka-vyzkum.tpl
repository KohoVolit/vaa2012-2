   ...
   <div data-role="page" id="page">
	...
	<div data-role="popupx" id="popup" class="ui-content">
	  ...
	  <form action="save_research.php" method="post" data-ajax="false">
	    ...
	    <p>Účast na výzkumu není povinná, můžete jej <button type="submit" data-mini="true" data-inline="true" name="upper-submit" value="upper-submit" >přeskočit rovnou na Volební kalkulačku</button></p>
	    ...
	    <!-- education -->
	    <fieldset data-role="controlgroup" data-type="horizontal" class="even" > 
		  <legend><b>12. Jaké je Vaše nejvyšší dosažené vzdělání?</b></legend>
