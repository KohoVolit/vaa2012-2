    	...
    	<h3>Vložit kalkulačku k sobě na web</h3>
            <div data-role="fieldcontain">
				<p>Vložte kód HTML (standardní Inventura hlasování):</p>
					<textarea data-role="none" cols="40" rows="3" name="textarea" id="textarea"><iframe src="http://volebnikalkulacka.cz/nemecko-2013/&key=result_inventura" width="650" height="550" frameborder="0" ></iframe></textarea><br/>
	...
	<div class="question match-other-calc">
	  Volební kalkulačka počítající shodu s programy kandidujících stran v ČR bude spuštěna: <div class="match-other-calc-strong">25.9.2013</div>
	</div>
