...
<head>
	...
	<title>Volba prezidenta ČR 2013 | Volební kalkulačka</title>
	<meta name="description" content="Zjistěte, s kterým kandidátem na prezidenta se nejvíce shodujete. Kdo Vás bude doopravdy zastupovat!" />
...
{foreach $questions as $question}
  <!-- Start of {$key} page -->
  <div data-role="page" id="p{$key}" data-title="{$question->name} | Volební kalkulačka" class='page type-interior partner-{$partner['name']}'>
    <!-- header -->
