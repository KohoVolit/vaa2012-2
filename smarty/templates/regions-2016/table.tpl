...
{*                            {$voter->{$settings->table->picture_title}}*}
        ...
        <div class="well well-xl">
            ...
            <a href="{$settings->cdn_domain}{$settings->directory}/questions_all_{$cc}.json">{$text['download_questions']}</a>,
            <a href="{$settings->cdn_domain}{$settings->directory}/answers_{$cc}.json">{$text['download_answers']}</a>,
            <a href="{$settings->cdn_domain}{$settings->directory}/details_{$cc}.json">{$text['download_details']}</a>
        </div>
    {/block}
