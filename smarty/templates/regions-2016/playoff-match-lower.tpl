<div class="text-center">
  ...
  <a href="../../match/?{$server['QUERY_STRING']}" type="button" class="btn btn-warning btn-lg sharebutton" id="lower-full-comparison"><i class="fa fa-angle-double-down fa-lg"></i> Porovnání se všemi stranami</a>
