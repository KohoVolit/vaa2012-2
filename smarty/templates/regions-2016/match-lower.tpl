<div class="text-center">
  ...
  {/if}
  <a href="../../senat-2016/select.php" type="button" class="btn btn-warning btn-lg sharebutton" id="lower-table"><i class="fa fa-university fa-lg"></i> Zkuste i Volební kalkulačku pro Senát</a>
</div>
