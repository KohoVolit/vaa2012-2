...
<html>
  ...
  <div data-role="page" data-title="Moje shoda{if $partner['name'] == 'default'} | VolebníKalkulačka.cz{/if}" data-theme="b" class='page type-interior partner-{$partner['name']}'>
	...
	<div data-role="content" class="content">
		<!-- winner block -->
		{include "match-winner-president-2.tpl"}
	  ...
	  <div data-role="collapsible" data-theme="d" data-content-theme="e">
    	<h3>Vložte si volební kalkulačku k sobě na stránky</h3>
            <div data-role="fieldcontain">
				<p>Vložte kód HTML (standardní kalkulačka):</p>
					<textarea data-role="none" cols="40" rows="3" name="textarea" id="textarea"><iframe src="http://volebnikalkulacka.cz/volba-prezidenta-cr-2-kolo-2013/&key=result_president" width="650" height="550" frameborder="0" ></iframe></textarea><br/>
	...
	<div class="box-center-match match-winner-box">
	  Více o obou kandidátech se dozvíte na <a href="http://nasipolitici.cz">NašiPolitici.cz</a>
	</div><!-- /nasi politici -->
